...
<div class="courseModules">
    <div class="cModule">
        ...
        <div class="courseModuleInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/module"><h2>Модуль 1. Основи PHP</h2></a>
    ...
    <div class="cModule">
        ...
        <div class="courseModuleInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/module"><h2>Модуль 2. Семантичне ядро сайту</h2></a>
    ...
    <div class="cModule">
        ...
        <div class="courseModuleInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/module"><h2>Модуль 3. Зовнішні ресурси в просуванні</h2></a>
    ...
    <div class="cModule">
        ...
        <div class="courseModuleInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/module"><h2>Модуль 4. Запити HTTP, URL параметри і форми HTML</h2></a>
    ...
    <div class="cModule">
        ...
        <div class="courseModuleInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/module"><h2>Модуль 5. Cookies Урок і сесії</h2></a>
    ...
    <div class="cModule">
        ...
        <div class="courseModuleInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/module"><h2>Модуль 6. Робота з файлами</h2></a>
    ...
    <div class="cModule">
        ...
        <div class="courseModuleInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/module"><h2>Модуль 7. Урок Робота з базою даних</h2></a>
