...
$this->breadcrumbs=array(
    Yii::t('breadcrumbs', 'Courses')=>Yii::app()->request->baseUrl."/index.php/?r=courses",'Програмування для чайників'=>Yii::app()->request->baseUrl."/index.php/?r=course",'Основи PHP',
);
?>
...
<div class="ModuleModules">
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/?r=lesson"><h2>Заняття 1. Основи PHP</h2></a>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/?r=lesson"><h2>Заняття 2. Семантичне ядро сайту</h2></a>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/?r=lesson"><h2>Заняття 3. Зовнішні ресурси в просуванні</h2></a>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/?r=lesson"><h2>Заняття 4. Запити HTTP, URL параметри і форми HTML</h2></a>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/?r=lesson"><h2>Заняття 5. Cookies Заняття і сесії</h2></a>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/?r=lesson"><h2>Заняття 6. Робота з файлами</h2></a>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/?r=lesson"><h2>Заняття 7. Заняття Робота з базою даних</h2></a>
