...
?>
<!-- BD -))) -->
<div class="subNavBlockModule">
    <div class="subLinksModule">
        <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php">Головна</a> &#187; <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=modules">Модулі</a> &#187; <a href="#">Основи PHP</a>
    </div>
</div>
...
<div class="ModuleModules">
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <h2>Урок 2. Семантичне ядро сайту</h2>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <h2>Урок 3. Зовнішні ресурси в просуванні</h2>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <h2>Урок 4. Запити HTTP, URL параметри і форми HTML</h2>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <h2>Урок 5. Cookies Урок і сесії</h2>
    ...
    <div class="mLessons">
        ...
        <div class="ModulesLessonInfo">
            <h2>Урок 7. Урок Робота з базою даних</h2>
