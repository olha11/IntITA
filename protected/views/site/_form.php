					...
					<a href="#" class="arrow left-arrow" id="prev"><p><</p></a>
						<div id="uLogin" x-ulogin-params="display=buttons;fields=first_name,last_name;
							...
							<ul id="uLoginImages">
								...
								<li><img src="<?php echo Yii::app()->request->baseUrl; ?>/css/images/iconsSingin/vkontakte.png" x-ulogin-button = "vkontakte" title="VKontakte"/></li>
								...
								<li><img src="<?php echo Yii::app()->request->baseUrl; ?>/css/images/iconsSingin/instagram.png" x-ulogin-button = "instagram" title="Instagram"/></li>
