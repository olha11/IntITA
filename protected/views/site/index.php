...
?>
    ...
    <div class="fon"style="background:url('<?php echo Yii::app()->request->baseUrl; ?>/css/images/fon.png') no-repeat;">
        ...
        <div class="formFon"style=" background:url('<?php echo $mainpage['formFon']; ?>');">
            ...
            <br>
                    <div class="button">
                <input type="submit" name="button" class="button1" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/css/images/pointer.png'); background-repeat: no-repeat; background-position: 145px 54%;" value="<?php echo $mainpage['formButtonStart']; ?>"/>
                </form>
        </div>
