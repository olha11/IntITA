...
$block1->drop1Text='<span class="detailTitle1">'.$block1["titleText"].'</span>';
?>
...
<?php $block3->drop3Text='<span class="detailTitle1">'.$block3["titleText"].'</span>';
?>
<br/>
