...
$objAbout1=@new AboutUs(Yii::app()->request->baseUrl.'/css/images/line2.png',Yii::app()->request->baseUrl.'/css/images/image1.png','Про що мрієш ти?','Спробуємо вгадати: власна квартира чи навіть будинок? Гарний автомобіль?
                        Закордонні подорожі, можливо, до екзотичних країн?');
$objAbout2=@new AboutUs (Yii::app()->request->baseUrl.'/css/images/line2.png',Yii::app()->request->baseUrl.'/css/images/image2.png','Навчання майбутнього сьогодні','Програмування – Програмування – це не так складно, як ти можеш уявляти.
                        Безумовно, щоб стати хорошим програмістом, потрібен час та зусилля.');
$objAbout3=@new AboutUs(Yii::app()->request->baseUrl.'/css/images/line2.png',Yii::app()->request->baseUrl.'/css/images/image3.png','Питання, які нам часто ставлять','Самостійний графік навчання.
                        Лише 100% необхідні знання. Засвоєння 100% знаннь!');					
$massAbout=array($objAbout1,$objAbout2,$objAbout3);

$objAbout1->drop1Text='<span class="detailTitle1"> Про що мрієш ти? </span>
...
<p><span class="detailTitle2">Що очікується від тебе</span>
...
$objAbout1->drop2Text='<span class="detailTitle1">Навчання майбутнього сьогодні</span>
...
<p><span class="detailTitle2">“Три кити” Академії ІНТІТА </span>
...
<p><span class="detailTitle3">Кит другий. Орієнтація на ринок. </span>
...
<p>Порівнюючи звичайний технічний виш та академію ІНТІТА, ти можеш думати про сімейний універсал та болід Формула-1. Перший підходить для широкого кола завдань, але він значно програє позашляховикам у прохідності, міні-венам у місткості, лімузинам - у комфорті, спротивним автомобілям - у швидкості та керуванні. Другий сконструйовано лише заради максимальної швидкості та маневреності, жертвуючи усім іншим. І в результаті ми не зробимо з тебе універсально освічену людину, яка розбирається потрохи у всьому, ми зробимо тебе професіоналом світового класу в області програмування.  
 <p><span class="detailTitle3">Кит третій. Результативність. </span>
...
<tr><td>Диплом про вищу освіту видається через 5-6 років за умови засвоєння великої кількості непрофільних знань (мова, історія, філософія тощо)</td><td>Лише практичні знання, які будуть потрібні тобі у роботі та житті: програмування, англійська мова, побудова карєри на ринку інформаційних технологій, основи життєвого успіху.</td><td>Весь час навчання витрачається на отримання корисних практичних знань, тому термін навчання скорочуються, а кількість практичних засвоєних знань більша, ніж у традиційних закладах.</td></tr>
 ...
 $objAbout1->drop3Text='
<span class="detailTitle1"> Питання, які нам часто ставлять</span>
...
<div id="dropTextLayer1" >
    <div  class="textBox">
	<?php 	echo $objAbout1->drop1Text;	 ?>
    </div>
</div>	
<div id="dropTextLayer2" >
    <div  class="textBox">
	<?php 	echo $objAbout1->drop2Text;	 ?>
    </div>
</div>	
<div id="dropTextLayer3">
    <div  class="textBox">
	<?php 	echo $objAbout1->drop3Text;	 ?>
    </div>
</div>	
</div>
